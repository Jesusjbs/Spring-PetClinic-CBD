...
This is a fork of https://github.com/spring-projects/spring-petclinic to be used for the CBD course. The main changes that have been performed were:
- Modify the project to use an object-oriented database like ObjectDB.
...
gets populated at startup with data. We will change that and use ObjectDB.
